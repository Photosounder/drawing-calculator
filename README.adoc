...
- `number <pos X of centre> <pos Y> <scale of the glyphs> <value to show> <max number of digits to show>`
+
For instance `d v = number 0 0 1 pi 7` will show `3.141593`.
...
d v = colour -0.6 0 -0.4
v = number 0 0.5 7/12 2pi 7
```
